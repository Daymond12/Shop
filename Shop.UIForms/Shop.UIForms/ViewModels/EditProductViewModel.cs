...
namespace Shop.UIForms.ViewModels
{
    ...
    public class EditProductViewModel : BaseViewModel
    {
        ...
        private async void SaveProduct()
        {
            ...
            if(this.Product.User.PhoneNumber.Contains(" "))
                {
             this.Product.User.PhoneNumber = this.Product.User.PhoneNumber.Replace(" ","");
            ...
            var response = await this.apiService.PutAsync(
                url,
                //vas a la url, con el prefijo api, controlador products
                "/api",
                "/Products",
                //le mandamos el id
                //el modelo¨Product
